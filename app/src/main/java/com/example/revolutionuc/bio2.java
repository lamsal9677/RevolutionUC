...
public class bio2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.Ans1).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                findViewById(R.id.Ans1).setBackgroundResource(R.drawable.correct);
                ...
                DatabaseReference myRef = database.getReference("quiz33");
                myRef.setValue(1);
            }
        });
