    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reff.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                String name=dataSnapshot.child("quiz21").getValue().toString();
                String name1=dataSnapshot.child("quiz22").getValue().toString();
                String name2=dataSnapshot.child("quiz23").getValue().toString();
        ...
        findViewById(R.id.imageView2).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(chemistry.this, chem.class);
                startActivity(i);
            }
        });
        ...
        findViewById(R.id.imageView4).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(chemistry.this, chem1.class);
                startActivity(i);
            }
        });
        ...
        findViewById(R.id.imageView6).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(chemistry.this, chem2.class);
                startActivity(i);
            }
        });
        ...
        findViewById(R.id.imageView8).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(chemistry.this, chemfinal.class);
                startActivity(i);
            }
        });
    }
